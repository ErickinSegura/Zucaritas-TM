...
namespace AWAQPagina.Pages
{
    public class IndexModel : PageModel
    {
        ...
        private readonly string _connectionString = "Server=127.0.0.1;Port=3306;Database=AWAQ;Uid=root;password=Vela0376;";
                    ...
                    if (count > 0)
                    {
                        ...
                        using (MySqlCommand command2 = new MySqlCommand(sql2, connection))
                        {
                            ...
                            if (result != null)
                            {
                                ...
                                _httpContextAccessor.HttpContext.Response.Cookies.Append("ID_USER", UserId);
                            }
                        }
